...
//
class cCustomView1 extends cTable {
	var $id;
	var $fecha;
	var $hora;
	var $temp;
	...
	function __construct() {
		...
		// Update Table
		$this->UpdateTable = "(select * from tempe order by fecha desc,hora desc limit 1) `EW_CV_CustomView1`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('CustomView1', 'CustomView1', 'x_id', 'id', '`id`', '`id`', 20, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// fecha
		$this->fecha = new cField('CustomView1', 'CustomView1', 'x_fecha', 'fecha', '`fecha`', 'DATE_FORMAT(`fecha`, \'%d/%m/%Y\')', 133, 7, FALSE, '`fecha`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fecha->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['fecha'] = &$this->fecha;

		// hora
		$this->hora = new cField('CustomView1', 'CustomView1', 'x_hora', 'hora', '`hora`', 'DATE_FORMAT(`hora`, \'%d/%m/%Y\')', 134, 7, FALSE, '`hora`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->hora->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['hora'] = &$this->hora;

		// temp
		$this->temp = new cField('CustomView1', 'CustomView1', 'x_temp', 'temp', '`temp`', '`temp`', 4, -1, FALSE, '`temp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->temp->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['temp'] = &$this->temp;

		// hum
		$this->hum = new cField('CustomView1', 'CustomView1', 'x_hum', 'hum', '`hum`', '`hum`', 4, -1, FALSE, '`hum`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->hum->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['hum'] = &$this->hum;

		// co2ppm
		$this->co2ppm = new cField('CustomView1', 'CustomView1', 'x_co2ppm', 'co2ppm', '`co2ppm`', '`co2ppm`', 4, -1, FALSE, '`co2ppm`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->co2ppm->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['co2ppm'] = &$this->co2ppm;

		// higromet
		$this->higromet = new cField('CustomView1', 'CustomView1', 'x_higromet', 'higromet', '`higromet`', '`higromet`', 4, -1, FALSE, '`higromet`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->higromet->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['higromet'] = &$this->higromet;

		// luz
		$this->luz = new cField('CustomView1', 'CustomView1', 'x_luz', 'luz', '`luz`', '`luz`', 200, -1, FALSE, '`luz`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['luz'] = &$this->luz;

		// maqhum
		$this->maqhum = new cField('CustomView1', 'CustomView1', 'x_maqhum', 'maqhum', '`maqhum`', '`maqhum`', 16, -1, FALSE, '`maqhum`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->maqhum->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['maqhum'] = &$this->maqhum;

		// maqdesh
		$this->maqdesh = new cField('CustomView1', 'CustomView1', 'x_maqdesh', 'maqdesh', '`maqdesh`', '`maqdesh`', 16, -1, FALSE, '`maqdesh`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->maqdesh->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['maqdesh'] = &$this->maqdesh;

		// maqcale
		$this->maqcale = new cField('CustomView1', 'CustomView1', 'x_maqcale', 'maqcale', '`maqcale`', '`maqcale`', 16, -1, FALSE, '`maqcale`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->maqcale->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['maqcale'] = &$this->maqcale;

		// modman
		$this->modman = new cField('CustomView1', 'CustomView1', 'x_modman', 'modman', '`modman`', '`modman`', 16, -1, FALSE, '`modman`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modman->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['modman'] = &$this->modman;

		// periodo
		$this->periodo = new cField('CustomView1', 'CustomView1', 'x_periodo', 'periodo', '`periodo`', '`periodo`', 16, -1, FALSE, '`periodo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->periodo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['periodo'] = &$this->periodo;

		// horasluz
		$this->horasluz = new cField('CustomView1', 'CustomView1', 'x_horasluz', 'horasluz', '`horasluz`', '`horasluz`', 16, -1, FALSE, '`horasluz`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->horasluz->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['horasluz'] = &$this->horasluz;

		// fechaini
		$this->fechaini = new cField('CustomView1', 'CustomView1', 'x_fechaini', 'fechaini', '`fechaini`', 'DATE_FORMAT(`fechaini`, \'%d/%m/%Y\')', 133, 7, FALSE, '`fechaini`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "(select * from tempe order by fecha desc,hora desc limit 1) `EW_CV_CustomView1`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("customview1view.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("customview1view.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "customview1add.php?" . $this->UrlParm($parm);
		else
			$url = "customview1add.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("customview1edit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("customview1add.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->fechaini->EditValue = ew_FormatDateTime($this->fechaini->CurrentValue, 7);
