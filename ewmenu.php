...
$RootMenu->AddMenuItem(5, "mi_grafico_php", $Language->MenuPhrase("5", "MenuText"), "grafico.php", -1, "", IsLoggedIn(), FALSE);
...
$RootMenu->AddMenuItem(6, "mi_parametros", $Language->MenuPhrase("6", "MenuText"), "parametroslist.php", -1, "", IsLoggedIn(), FALSE);
