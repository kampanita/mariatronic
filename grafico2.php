...
class cgrafico2_php {
	...
	// Table name
	var $TableName = 'grafico2.php';

	// Page object name
	var $PageObjName = 'grafico2_php';
	...
	function __construct() {
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'grafico2.php', TRUE);
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("custom", "grafico2_php", $url, "", "grafico2_php", TRUE);
	}
}
?>
<?php ew_Header(TRUE) ?>
