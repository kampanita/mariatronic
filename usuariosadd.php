...
<input type="text" data-table="usuarios" data-field="x_usuario" name="x_usuario" id="x_usuario" size="30" maxlength="32" placeholder="<?php echo ew_HtmlEncode($usuarios->usuario->getPlaceHolder()) ?>" value="<?php echo $usuarios->usuario->EditValue ?>"<?php echo $usuarios->usuario->EditAttributes() ?>>
</span>
<?php echo $usuarios->usuario->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($usuarios->passwd->Visible) { // passwd ?>
	<div id="r_passwd" class="form-group">
		<label id="elh_usuarios_passwd" for="x_passwd" class="col-sm-2 control-label ewLabel"><?php echo $usuarios->passwd->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $usuarios->passwd->CellAttributes() ?>>
<span id="el_usuarios_passwd">
<div class="input-group" id="ig_x_passwd">
<input type="password" data-password-strength="pst_x_passwd" data-password-generated="pgt_x_passwd" data-table="usuarios" data-field="x_passwd" name="x_passwd" id="x_passwd" size="30" maxlength="32" placeholder="<?php echo ew_HtmlEncode($usuarios->passwd->getPlaceHolder()) ?>"<?php echo $usuarios->passwd->EditAttributes() ?>>
...
<?php echo $usuarios->passwd->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div>
