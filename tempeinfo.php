...
//
// Table class for tempe
//
class ctempe extends cTable {
	var $id;
	var $fecha;
	var $hora;
	var $temp;
	...
	function __construct() {
		...
		$this->TableVar = 'tempe';
		$this->TableName = 'tempe';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`tempe`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('tempe', 'tempe', 'x_id', 'id', '`id`', '`id`', 20, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// fecha
		$this->fecha = new cField('tempe', 'tempe', 'x_fecha', 'fecha', '`fecha`', 'DATE_FORMAT(`fecha`, \'%Y/%m/%d\')', 133, 5, FALSE, '`fecha`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fecha->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateYMD"));
		$this->fields['fecha'] = &$this->fecha;

		// hora
		$this->hora = new cField('tempe', 'tempe', 'x_hora', 'hora', '`hora`', 'DATE_FORMAT(`hora`, \'%Y/%m/%d\')', 134, -1, FALSE, '`hora`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->hora->FldDefaultErrMsg = $Language->Phrase("IncorrectTime");
		$this->fields['hora'] = &$this->hora;

		// temp
		$this->temp = new cField('tempe', 'tempe', 'x_temp', 'temp', '`temp`', '`temp`', 4, -1, FALSE, '`temp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->temp->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['temp'] = &$this->temp;

		// hum
		$this->hum = new cField('tempe', 'tempe', 'x_hum', 'hum', '`hum`', '`hum`', 4, -1, FALSE, '`hum`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->hum->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['hum'] = &$this->hum;

		// co2ppm
		$this->co2ppm = new cField('tempe', 'tempe', 'x_co2ppm', 'co2ppm', '`co2ppm`', '`co2ppm`', 4, -1, FALSE, '`co2ppm`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->co2ppm->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['co2ppm'] = &$this->co2ppm;

		// higromet
		$this->higromet = new cField('tempe', 'tempe', 'x_higromet', 'higromet', '`higromet`', '`higromet`', 4, -1, FALSE, '`higromet`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->higromet->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['higromet'] = &$this->higromet;

		// luz
		$this->luz = new cField('tempe', 'tempe', 'x_luz', 'luz', '`luz`', '`luz`', 200, -1, FALSE, '`luz`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['luz'] = &$this->luz;

		// maqhum
		$this->maqhum = new cField('tempe', 'tempe', 'x_maqhum', 'maqhum', '`maqhum`', '`maqhum`', 16, -1, FALSE, '`maqhum`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->maqhum->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['maqhum'] = &$this->maqhum;

		// maqdesh
		$this->maqdesh = new cField('tempe', 'tempe', 'x_maqdesh', 'maqdesh', '`maqdesh`', '`maqdesh`', 16, -1, FALSE, '`maqdesh`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->maqdesh->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['maqdesh'] = &$this->maqdesh;

		// maqcale
		$this->maqcale = new cField('tempe', 'tempe', 'x_maqcale', 'maqcale', '`maqcale`', '`maqcale`', 16, -1, FALSE, '`maqcale`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->maqcale->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['maqcale'] = &$this->maqcale;

		// modman
		$this->modman = new cField('tempe', 'tempe', 'x_modman', 'modman', '`modman`', '`modman`', 16, -1, FALSE, '`modman`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modman->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['modman'] = &$this->modman;

		// periodo
		$this->periodo = new cField('tempe', 'tempe', 'x_periodo', 'periodo', '`periodo`', '`periodo`', 16, -1, FALSE, '`periodo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->periodo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['periodo'] = &$this->periodo;

		// horasluz
		$this->horasluz = new cField('tempe', 'tempe', 'x_horasluz', 'horasluz', '`horasluz`', '`horasluz`', 16, -1, FALSE, '`horasluz`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->horasluz->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['horasluz'] = &$this->horasluz;

		// fechaini
		$this->fechaini = new cField('tempe', 'tempe', 'x_fechaini', 'fechaini', '`fechaini`', 'DATE_FORMAT(`fechaini`, \'%Y/%m/%d\')', 133, 5, FALSE, '`fechaini`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`tempe`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("tempeview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("tempeview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "tempeadd.php?" . $this->UrlParm($parm);
		else
			$url = "tempeadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("tempeedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("tempeadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("tempedelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->fechaini->EditValue = ew_FormatDateTime($this->fechaini->CurrentValue, 5);
