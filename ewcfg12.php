...
define("EW_DEFAULT_DATE_FORMAT", "", TRUE); // Default date format
define("EW_DEFAULT_DATE_FORMAT_ID", "0", TRUE); // Default date format
define("EW_DATE_SEPARATOR", "/", TRUE); // Date separator
define("EW_UNFORMAT_YEAR", 50, TRUE); // Unformat year
define("EW_PROJECT_NAME", "PROYECTO_BUENO_USAR_EL_12", TRUE); // Project name
...
define("EW_RANDOM_KEY", 'JN0jRru9nqviCIqb', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "indarra", "db" => "temperatura", "qs" => "`", "qe" => "`");
...
define("EW_CODEPAGE", 28605, TRUE); // Code page
 ...
 * details.
 */
define("EW_ENCODING", "ISO-8859-15", TRUE); // Character encoding
...
define("EW_ADMIN_PASSWORD", "indarra", TRUE); // Administrator password
