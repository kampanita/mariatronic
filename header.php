...
<div class="ewLayout">
	...
	<div id="ewHeaderRow" class="<?php echo $gsHeaderRowClass ?>"><img src="<?php echo $EW_RELATIVE_PATH ?>phpimages/phpmkrlogo1.png" alt="" style="width: 100%;"><center><h2><span class="label label-success">MariaTronic</span></h2></center></div>
<?php if (ew_IsResponsiveLayout()) { ?>
